...
push @files, glob("mcc216/sdflash.bin");
...
push @files, glob("mcctv/sdflash.bin");
...
push @files, glob("mist/sdflash.bin");
...
push @files, glob("chameleon/chameleon.bin");
...
push @files, glob("chameleon2/chameleon.bin");
...
push @files, glob("eclaireXL_ITX/build*/output_files/*.rpd");
push @files, glob("eclaireXL_ITX/build*/output_files/*.jic");
