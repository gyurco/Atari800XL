...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/markw/intelFPGA_lite/19.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/altchip_id/cadence/altchip_id.v" -work chipid -cdslib ./cds_libs/chipid.cds.lib
