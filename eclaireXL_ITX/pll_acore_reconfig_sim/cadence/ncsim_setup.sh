...
TOP_LEVEL_NAME="pll_acore_reconfig"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/markw/fpga/intelFPGA_lite/16.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/pll_acore_reconfig/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/altera_pll_reconfig/altera_pll_reconfig_top.v"  -work pll_acore_reconfig -cdslib ./cds_libs/pll_acore_reconfig.cds.lib
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/altera_pll_reconfig/altera_pll_reconfig_core.v" -work pll_acore_reconfig -cdslib ./cds_libs/pll_acore_reconfig.cds.lib
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/altera_pll_reconfig/altera_std_synchronizer.v"  -work pll_acore_reconfig -cdslib ./cds_libs/pll_acore_reconfig.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_acore_reconfig.vhd"                                                                                               
fi
