...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_pll_reconfig/altera_pll_reconfig_top.v"  -work pll_acore_reconfig
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_pll_reconfig/altera_pll_reconfig_core.v" -work pll_acore_reconfig
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_pll_reconfig/altera_std_synchronizer.v"  -work pll_acore_reconfig
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_acore_reconfig.vhd"                                                 
fi
