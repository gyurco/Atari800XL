...
# ACDS 16.1 196 linux 2016.11.30.20:35:25
# ----------------------------------------
...
# ----------------------------------------
# If pll_acore is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_acore.vho"
}
