...
# ----------------------------------------
# If pll_hdmi2 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.0 614 linux 2020.02.02.21:28:40
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_hdmi2.vho"
}
