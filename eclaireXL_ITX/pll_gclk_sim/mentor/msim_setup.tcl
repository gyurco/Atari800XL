...
# ----------------------------------------
# If pll_gclk is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.1 196 linux 2016.11.30.20:27:28
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_gclk.vho"
}
