...
# ----------------------------------------
# If pll_usb is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.0 614 linux 2020.02.02.21:03:29
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_usb.vho"
}
