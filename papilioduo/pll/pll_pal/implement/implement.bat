...
xst -ifn xst.scr
move pll_pal_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\pll_pal_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pll_pal_exdes.ucf pll_pal_exdes

echo 'Running map'
map -timing -pr b pll_pal_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm pll_pal_exdes -w routed.ncd routed.vhd
cd ..
