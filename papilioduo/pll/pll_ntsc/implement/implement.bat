...
xst -ifn xst.scr
move pll_ntsc_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\pll_ntsc_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pll_ntsc_exdes.ucf pll_ntsc_exdes

echo 'Running map'
map -timing -pr b pll_ntsc_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm pll_ntsc_exdes -w routed.ncd routed.vhd
cd ..
